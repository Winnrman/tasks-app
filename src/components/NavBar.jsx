const NavBar = (props) => {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="m6.75 7.5 3 2.25-3 2.25m4.5 0h3m-9 8.25h13.5A2.25 2.25 0 0 0 21 18V6a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 6v12a2.25 2.25 0 0 0 2.25 2.25Z" />
                ...
                <button className={`sm:w-12 sm:h-12 w-full text-xs text-black items-center justify-center flex flex-col gap-1 hover:bg-slate-200 py-1 rounded-md ${props.active === 'settings' ? 'text-black font-semibold' : ''}`} onClick={() => props.handleSetCurrentTab('settings')}>
