const NavBar = (props) => {
        ...
        <div className="flex sm:flex-col flex-row sm:h-screen h-fit bg-white border-r border-slate-300 sm:w-auto sm:min-w-16 sm:items-center w-full p-1 sm:order-first order-last">
            <div className="flex sm:space-between sm:flex-col flex-row sm:w-fit w-full sm:h-full">
                ...
                <button className={`sm:w-12 sm:h-12 w-full text-xs items-center justify-center flex flex-col gap-1 hover:bg-slate-200 py-1 rounded-md ${props.active === 'archived' ? 'text-black font-semibold' : ''}`} onClick={() => props.handleSetCurrentTab('archived')}>
                    ...
                    {props.active === 'archived' ? 'Archived' : null}
                </button>


                <button className={`sm:w-12 sm:h-12 w-full text-xs text-black items-center justify-center flex flex-col gap-1 hover:bg-slate-200 py-1 rounded-md ${props.active === 'shared' ? 'text-black font-semibold' : ''}`} onClick={() => props.handleSetCurrentTab('shared')}>
                    {props.active === 'shared' ?
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-black">
                    ...
                    {props.active === 'shared' ? 'Shared' : null}
                </button>


                <button className={`sm:w-12 sm:h-12 w-full text-xs text-black items-center justify-center flex flex-col gap-1 hover:bg-slate-200 py-1 rounded-md ${props.active === 'timer' ? 'text-black font-semibold' : ''}`} onClick={() => props.handleSetCurrentTab('timer')}>
                    {props.active === 'timer' ?
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-black">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 0 1 0 3.75H5.625a1.875 1.875 0 0 1 0-3.75Z" />
                    ...
                    {props.active === 'kanban' ? 'Kanban' : null}
                </button>
                </div>
                </div>
                <div>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="m6.75 7.5 3 2.25-3 2.25m4.5 0h3m-9 8.25h13.5A2.25 2.25 0 0 0 21 18V6a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 6v12a2.25 2.25 0 0 0 2.25 2.25Z" />
                    ...
                    {props.active === 'terminal' ? 'Terminal' : null}
                </button>
                <button className={`sm:w-12 sm:h-12 h-full w-full text-xs text-black items-center justify-center flex flex-col gap-1 hover:bg-slate-200 py-1 rounded-md ${props.active === 'settings' ? 'text-black font-semibold' : ''}`} onClick={() => props.handleSetCurrentTab('settings')}>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                    ...
                    {props.active === 'settings' ? 'Settings' : null}
                </button>
                <button className={`sm:w-12 sm:h-12 h-full w-full text-xs text-black items-center justify-center flex flex-col gap-1 hover:bg-slate-200 py-1 rounded-md`} onClick={() => {props.handleLogout()}}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
